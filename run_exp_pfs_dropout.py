...
from model_utils import VSequenceFeatureMCDropOut, LinearModel, \
    EpochOutputStore, CheckPointAfter
...
def run(batch_size=64, lr=3e-4, alpha=1e-3, n_hidden_sta=4, n_hidden_temp=32,
    ...
    backbone = VSequenceFeatureMCDropOut(n_feature_sta, n_feature_temp,
...
if __name__ == '__main__':
    ...
    for f in range(5):
        run(batch_size=bs, lr=lrt, alpha=a,
            ...
            run_name=f'{m_name}_linear_regressor_dropout',
            seed=sd)
